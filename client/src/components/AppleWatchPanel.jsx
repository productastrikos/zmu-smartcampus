...
/**
 * AppleWatchPanel — command-staff wellness, sourced from Apple Watch devices
 * issued to senior officers (Apple Health → the same consent-governed wearable
 * middleware the cadet Garmin feed uses, kept as a separate cohort). Renders the
 * three Apple activity rings plus headline vitals. Values are demo aggregates.
 *
...
export default function AppleWatchPanel() {
  const { t } = useLang();
